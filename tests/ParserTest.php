...
class ParserTest extends TestCase
{
    ...
    public function testParsedMapShouldContainAllData()
    {
        ...
        $deps = [
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_Advert.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_Advert.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_U.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_U.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_D.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_D.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_DL.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_DL.png",
            ],
            ['file' => "Skins\Stadium\CircuitScreen\WhiteLeft.webm"],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_R.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_R.png",
            ],
            ['file' => "Skins\Stadium\CircuitScreen\WhiteRight.webm"],
            ['file' => "Skins\Stadium\Inflatable\White.zip"],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_L.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_L.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_DR.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_DR.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_AlternativeRoute.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_AlternativeRoute.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_UL.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_UL.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_UR.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_UR.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_DriveBackwards.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_DriveBackwards.png",
            ],
            ['file' => "Skins\Any\Advertisement\U6gek3d.jpg", 'url' => "http://i.imgur.com/U6gek3d.jpg"],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_UTurn_R.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_UTurn_R.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_Loop_L.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_Loop_L.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_Respawn.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_Respawn.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_GPS.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_GPS.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_Gift1.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_Gift1.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_Gift2.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_Gift2.png",
            ],
            [
                'file' => "Skins\Any\Advertisement\CS_SpmWeekly_Gift3.png",
                'url'  => "http://maniacdn.net/toffe/spamweekly/CS_SpmWeekly_Gift3.png",
            ],
